...
def initializeEvents(gui):
    ...
    def configureEvents():
        ...
        ledCheckBoxEvents()
        gui.configure_save_button.clicked.connect(lambda: fileIO.saveConfiguration(gui))
        gui.configure_load_button.clicked.connect(lambda: fileIO.loadConfiguration(gui))
