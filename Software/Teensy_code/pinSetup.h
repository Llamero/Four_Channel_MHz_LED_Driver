...
class pinSetup
{
  public:
    ...
    const static int LED_FREQ = 58000; //LED driver PWM freq - default to 2^n multiple to have optimal dynamic range while staying outside the auditory range - https://www.pjrc.com/teensy/td_pulse.html
