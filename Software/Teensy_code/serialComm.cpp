...
const static char boot_dir[] = "boot_log"; //Directory to save boot log files into - max length 8 char
const static char awg_dir[] = "awg_file"; //Directory to save data log files into - max length 8 char
const static char header_dir[] = "awg_head"; //Directory to save data log files into - max length 8 char
const static char waveform_dir[] = "waveform"; //Directory to save recorded LED waveforms
...
void serialComm::inititializeSD(){
...
/////////////////CREATE DIRECTORIES IF NECESSARY/////////////////////////////////////
  ...
  for(int a = 0; a<boot_index; a++){
    boot_text[a][LCD_dim_x-1] = 0; //Replace all new lines with nulls for println() formatting
  }
}
